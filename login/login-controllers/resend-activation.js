(function(app) {
	app.ResendActivationComponent =
		...
		templateUrl: 'views/resend-activation-v1.html'
		})
		.Class({
	...
	app.ResendActivationComponent.prototype.keyupsearch=function(event){
	...
	app.ResendActivationComponent.prototype.calcYearCopy=function(){
		return calcYearCopy();
	}
	app.ResendActivationComponent.prototype.send=function(){
		...
		var mensajeAll="Error al reenviar código de activación";
